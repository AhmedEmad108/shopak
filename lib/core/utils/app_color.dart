...
abstract class AppColor {
  ...
  static const Color lightPrimaryColor = Color(0xff66A8EF);
  static const Color darkPrimaryColor = Color(0xff0259A6);
  ...
  static const Color background1Color = Color(0xffFDF4E2);
  static const Color background2Color = Color(0xffC8EFD8);
  static const Color background3Color = Color(0xffDDE8EC);
}
